...
import { Optional, Inject, ɵɵdefineInjectable, ɵɵinject, Injectable, ChangeDetectorRef, Input, Component, NgModule } from '@angular/core';
...
NgxLoadingService.ɵprov = ɵɵdefineInjectable({ factory: function NgxLoadingService_Factory() { return new NgxLoadingService(ɵɵinject("loadingConfig", 8)); }, token: NgxLoadingService, providedIn: "root" });
